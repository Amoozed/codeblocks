...
public class ItemBuilder {
    ...
    public ItemBuilder setLore(List<String> lore){
        ...
        for(String s : lore){
            fin.add(ChatColor.translateAlternateColorCodes('&', s));
        }
        this.presetLore = fin;
        return this;
    }
    ...
    public ItemStack build() {
        ...
        List<String> lore = (presetLore != null) ? presetLore : new ArrayList<>();
        ...
        if(tagData.size() > 0){
            ...
            for(int i = 0; i < tagData.keySet().size(); i++){
                ...
                container.set(new NamespacedKey(CodeBlocks.getPlugin(), key), type, value);
            }
        }
